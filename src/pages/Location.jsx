...
function Location() {
  ...
  useEffect(() => {
    const loadFeaturedEscorts = () => {
      ...
      const allEscorts = [
        {
          ...
          age: 24,
          location: 'Mumbai',
          image: '/images/profiles/escorts-in-airroli.jpg',
          description: 'Elegant and sophisticated beauty',
        ...
        },
        {
          ...
          age: 24,
          location: 'Mumbai',
          image: 'https://plus.unsplash.com/premium_photo-1705018501151-4045c97658a3?q=80&w=1170&auto=format&fit=crop',
          description: 'Charming beauty with warm personality',
        ...
        },
        {
          ...
          description: 'Charming and witty beauty',
        ...
        },
        {
          ...
          description: 'Elegant and mysterious enchantress',
          services: ['Events', 'Nightlife', 'Companionship'],
          rating: 4.92,
          verified: true,
        },
        {
          ...
          age: 25,
          location: 'Bangalore',
          image: 'https://images.unsplash.com/photo-1672940902418-f17e12ee2a46?w=600&auto=format&fit=crop',
          description: 'Graceful and alluring beauty',
          services: ['Events', 'Travel', 'Companionship'],
          rating: 4.8,
          verified: true,
        },
        {
          ...
          age: 23,
          location: 'Bangalore',
          image: 'https://images.unsplash.com/photo-1660963610697-fa0abf138da4?w=600&auto=format&fit=crop',
          description: 'Fun and adventurous spirit',
        ...
        },
        {
          ...
          age: 23,
          location: 'Hyderabad',
          image: 'https://plus.unsplash.com/premium_photo-1682089810582-f7b200217b67?w=600&auto=format&fit=crop',
          description: 'Adventurous and playful beauty',
        ...
        },
        {
          ...
          age: 25,
          location: 'Hyderabad',
          image: 'https://images.unsplash.com/photo-1624610806703-99c0852c31c0?w=600&auto=format&fit=crop',
          description: 'Sophisticated and cultured princess',
        ...
        },
        {
          ...
          age: 28,
          location: 'Pune',
          image: 'https://images.unsplash.com/photo-1672985352840-9ef34d22402d?w=600&auto=format&fit=crop',
          description: 'Sophisticated and refined beauty',
          services: ['Corporate Events', 'Dinner', 'Travel'],
          rating: 4.95,
          verified: true,
        },
        {
          ...
          age: 27,
          location: 'Pune',
          image: 'https://images.unsplash.com/photo-1766319244223-ae85903573d4?w=600&auto=format&fit=crop',
          description: 'Glamorous and confident fashionista',
        ...
        },
        {
          ...
          description: 'Vibrant and energetic beach beauty',
          services: ['Nightlife', 'Events', 'Entertainment'],
          rating: 4.6,
          verified: true,
        },
        {
          ...
          description: 'Beach beauty and free spirited charm',
        ...
        },
        {
          ...
          age: 25,
          location: 'Chennai',
          image: 'https://images.unsplash.com/photo-1488426862026-3ee34a7d66df?w=500&h=500&fit=crop',
          description: 'Cultured and traditional beauty',
          services: ['Cultural Events', 'Dinner', 'Travel'],
          rating: 4.82,
          verified: true,
        },
        {
          ...
          description: 'Graceful Bengali beauty',
          services: ['Art Events', 'Dinner', 'Travel'],
          rating: 4.86,
          verified: true,
        },
        {
        ...
        },
        {
          ...
          description: 'Royal charm and elegance',
          services: ['Heritage Tours', 'Events', 'Travel'],
          rating: 4.91,
          verified: true,
        },
        {
          ...
          description: 'Sophisticated business companion',
          services: ['Business Meetings', 'Dinner', 'Events'],
          rating: 4.77,
          verified: true,
        },
        {
          ...
          age: 24,
          location: 'Ahmedabad',
          image: 'https://images.unsplash.com/photo-1502716119720-b23a93e5fe1b?w=500&h=500&fit=crop',
          description: 'Elegant Gujarati beauty',
          services: ['Business Dinners', 'Events', 'Travel'],
          rating: 4.84,
          verified: true,
        },
        {
          ...
          description: 'Charming and sophisticated companion',
          services: ['Business Events', 'Dinner', 'Travel'],
          rating: 4.73,
          verified: true,
        },
        {
          ...
          description: 'Nawabi elegance and grace',
          services: ['Cultural Events', 'Dinner', 'Heritage Tours'],
          rating: 4.89,
          verified: true,
        },
        {
          ...
          description: 'Vibrant and engaging personality',
          services: ['Business Dinners', 'Events', 'Travel'],
          rating: 4.76,
          verified: true,
        },
      ...
      // Combine with advertiser profiles
      const combinedEscorts = [...allEscorts, ...advertiserProfiles]
