        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          >
            ...
            <motion.p variants={itemVariants} className="text-gray-400 max-w-2xl mx-auto">
              Discover our selection of exceptional escorts, each offering a unique experience tailored to your desires.
            </motion.p>
          </motion.div>
          ...
          >
            {featuredEscorts.map((companion) => {
              const currentImageIndex = imageIndices[companion.id]
              const currentImage = companion.gallery[currentImageIndex]
